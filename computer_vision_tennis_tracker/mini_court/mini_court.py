...
sys.path.append('../')
import constants
from utils import convert_meters_to_pixel_distance, convert_pixel_distance_to_meters, get_foot_position, get_closest_keypoint_index, get_height_of_bbox, measure_xy_distance, get_center_of_bbox, measure_distance
...
class MiniCourt():
    ...
    def set_court_drawing_key_points(self):
        ...
        drawing_key_points[5] = self.court_start_y + self.convert_meters_pixels(constants.HALF_COURT_LINE_HEIGHT*2)
        ...
        #Point 4
        drawing_key_points[8] = drawing_key_points[0] + self.convert_meters_pixels(constants.DOUBLE_ALLEY_DIFFERENCE)
        drawing_key_points[9] = drawing_key_points[1]

        #Point 5
        drawing_key_points[10] = drawing_key_points[4] + self.convert_meters_pixels(constants.DOUBLE_ALLEY_DIFFERENCE)
        drawing_key_points[11] = drawing_key_points[5]

        #Point 6
        drawing_key_points[12] = drawing_key_points[2] - self.convert_meters_pixels(constants.DOUBLE_ALLEY_DIFFERENCE)
        drawing_key_points[13] = drawing_key_points[3]

        #Point 7
        drawing_key_points[14] = drawing_key_points[6] - self.convert_meters_pixels(constants.DOUBLE_ALLEY_DIFFERENCE)
